    ...
    return (
      ...
      <Row>
        <Col s={12} l={4} m={4}>
          ...
          <p className="doctor-intro">한성대병원</p>
          <p className="doctor-name">원장 김택경</p>
          <p className="doctor-phone">010-9682-3215</p>
        </Col>
        <Col s={12} l={4} m={4}>
          <img src={myDoctors.doctorFace} alt="" className="circle image-doctor"/>
          <p className="doctor-intro">한성대병원 {myDoctors.department}</p>
        ...
        <Col s={12} l={4} m={4}>
          ...
          <p className="doctor-intro">한성대병원</p>
          <p className="doctor-name">부원장 박주만</p>
